...
|   | PROTOCOL / DEFAULT CONNECTION COMMAND SYNTAX SERVICE PORT ssh user@<IP> |
| --- | --- |
|   | SSH 22 Elevate shell: sudo -i (Ref: gtfobins.github.io) Telnet 23 telnet <IP> |
|   | xfreerdp /v:<TIP> /u:username RDP (CLI) 3389 GUI Client alternative: remmina |
|   | mysql -u <username> -h <TIP> -p <password> MySQL 3306 (Use upper-case -P for custom port specifications) FTP 21 ftp <IP> Typically associated with tools like RAT 9871, 6703 Theef (Client210.exe) |
...
| 0 100 110 160 900 | MODE PARAMETER (-M) HASH TARGET ARCHITECTURE TYPE MD5 SHA1 SHA1 with SALT HASH HMAC-SHA1 MD4 1000 NTLM 1400 SHA256 |
| --- | --- |
|   | 1800 SHA512CRYPT |
|   | 3200 BCRYPT |
